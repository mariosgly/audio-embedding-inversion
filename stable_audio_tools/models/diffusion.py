...
class DiTWrapper(ConditionedDiffusionModel):
    ...
    def forward(self,
        ...
        # print("\n" + "="*40)
        # print("2. DIT WRAPPER FORWARD (Final inputs to Transformer)")
        # print(f"Transformer Input (x): {x.shape}")
        # print(f"Transformer Timesteps (t): {t.shape}")
        # if cross_attn_cond is not None:
        #     print(f"Transformer cross_attn_cond: {cross_attn_cond.shape}")
        # if global_cond is not None:
        #     print(f"Transformer global_cond: {global_cond.shape}")
        # print("="*40 + "\n")
