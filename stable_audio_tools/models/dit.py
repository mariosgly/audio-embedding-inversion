...
class DiffusionTransformer(nn.Module):
    def __init__(self, 
        ...
        **kwargs):
        ...
        # print('I am at the init function of diffusion transformer and these are my settings')
        ...
        if global_cond_dim > 0:
            # print('we do have global conditioning')
            # Global conditioning
        ...
        if prepend_cond_dim > 0:
            # print('will prepend to the conditioning')
